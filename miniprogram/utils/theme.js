...
const THEMES = {
  default: {
    ...
    vars: {
      ...
      '--surface-strong': '#26323d',
      '--brand': '#4f7d8a',
      '--brand-soft': '#d8eef3',
      '--brand-strong': '#365e69',
      '--text-primary': '#202a33',
      '--text-secondary': '#5c6872',
      '--text-tertiary': '#89949d',
      '--border-soft': 'rgba(38, 50, 61, 0.12)',
      '--success': '#2f7d4a',
      '--danger': '#b64a3a',
      '--shadow-soft': '0 18rpx 40rpx rgba(38, 50, 61, 0.08)',
      '--hero-soft-start': '#f3f8fa',
      '--hero-soft-end': '#dbe7ec',
      '--hero-soft-glow': 'rgba(255, 255, 255, 0.48)',
      '--hero-soft-glow-weak': 'rgba(255, 255, 255, 0.24)',
      '--hero-soft-text': '#2f5260',
      '--hero-soft-subtle': '#6f8f9b',
