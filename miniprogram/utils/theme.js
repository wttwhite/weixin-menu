...
const THEMES = {
  default: {
    ...
    vars: {
      ...
      '--hero-soft-start': '#eee6f8',
      '--hero-soft-end': '#d7c8ef',
      '--hero-soft-glow': 'rgba(255, 255, 255, 0.48)',
      '--hero-soft-glow-weak': 'rgba(255, 255, 255, 0.24)',
      '--hero-soft-text': '#46395b',
      '--hero-soft-subtle': '#8576a0',
  ...
  'fresh-green': {
    ...
    vars: {
      ...
      '--hero-soft-start': '#ebe8f8',
      '--hero-soft-end': '#d1cbe9',
      '--hero-soft-glow': 'rgba(255, 255, 255, 0.5)',
      '--hero-soft-glow-weak': 'rgba(255, 255, 255, 0.24)',
      '--hero-soft-text': '#484063',
      '--hero-soft-subtle': '#8178a1',
  ...
  amber: {
    ...
    vars: {
      ...
      '--hero-soft-start': '#f2e8f8',
      '--hero-soft-end': '#dfc9ea',
      '--hero-soft-glow': 'rgba(255, 255, 255, 0.48)',
      '--hero-soft-glow-weak': 'rgba(255, 255, 255, 0.22)',
      '--hero-soft-text': '#554062',
      '--hero-soft-subtle': '#9279a2',
      '--hero-soft-chip-bg': 'rgba(255, 255, 255, 0.64)',
      '--hero-soft-chip-border': 'rgba(255, 255, 255, 0.34)',
  ...
  'tech-blue': {
    ...
    vars: {
      ...
      '--hero-soft-start': '#ecebfb',
      '--hero-soft-end': '#d0cff4',
      '--hero-soft-glow': 'rgba(255, 255, 255, 0.5)',
      '--hero-soft-glow-weak': 'rgba(255, 255, 255, 0.26)',
      '--hero-soft-text': '#4a4371',
      '--hero-soft-subtle': '#7e79ab',
  ...
  'sea-salt-blue': {
    ...
    vars: {
      ...
      '--hero-soft-start': '#efedfb',
      '--hero-soft-end': '#d4d2f0',
      '--hero-soft-glow': 'rgba(255, 255, 255, 0.5)',
      '--hero-soft-glow-weak': 'rgba(255, 255, 255, 0.24)',
      '--hero-soft-text': '#4a4567',
      '--hero-soft-subtle': '#7d79a1',
      '--hero-soft-chip-bg': 'rgba(255, 255, 255, 0.66)',
      '--hero-soft-chip-border': 'rgba(255, 255, 255, 0.34)',
      '--hero-soft-panel-bg': 'rgba(255, 255, 255, 0.58)'
    }
  ...
  'sakura-pink': {
    ...
    vars: {
      ...
      '--hero-soft-start': '#f6e9f7',
      '--hero-soft-end': '#e6cce9',
  ...
  'muted-gray-purple': {
    ...
    vars: {
      ...
      '--hero-soft-start': '#efe8f8',
      '--hero-soft-end': '#d8ceee',
      '--hero-soft-glow': 'rgba(255, 255, 255, 0.5)',
      '--hero-soft-glow-weak': 'rgba(255, 255, 255, 0.24)',
      '--hero-soft-text': '#53456a',
      '--hero-soft-subtle': '#8779a3',
      '--hero-soft-chip-bg': 'rgba(255, 255, 255, 0.66)',
      '--hero-soft-chip-border': 'rgba(255, 255, 255, 0.34)',
      '--hero-soft-panel-bg': 'rgba(255, 255, 255, 0.58)'
    }
